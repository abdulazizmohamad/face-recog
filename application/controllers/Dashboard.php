...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = 'Sistem Keamanan Pintu Face Recognition';
		$data['page'] = 'SISTEM KEAMANAN KUNCI PINTU R. SERVER';
	...
	{
		$data['isi'] = $this->M_users->getAllUserLog();
	...
	public function galery()
	{
		...
		$data['page'] = 'Documentasi';
		$data['content'] = 'admin/galery';
		$this->load->view('admin/menu', $data);
	}
